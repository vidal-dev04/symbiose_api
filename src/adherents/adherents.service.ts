...
export class AdherentsService {
  ...
  async create(data: any) {
    ...
    const adherentData: any = {
      ...
      ...(data.nationalite ? { nationalite: data.nationalite } : {}),
      ...(data.sexe ? { genre: data.sexe } : {}),
      ...(data.situationMatrimoniale ? { situationMatrimoniale: data.situationMatrimoniale } : {}),
      ...
      ...(data.secteurActivite ? { secteurActivite: data.secteurActivite } : {}),
